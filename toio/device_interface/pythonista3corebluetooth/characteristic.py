...
from .objc_types import CBCharacteristic, CBCharacteristicType
...
class BleakGATTCharacteristicPythonista3(BleakGATTCharacteristic):
    """GATT Characteristic implementation for the Pythonista3 backend"""

    def __init__(self, obj: CBCharacteristicType, max_write_without_response_size: int):
        super().__init__(obj, max_write_without_response_size)
        self.__descriptors: List[BleakGATTDescriptorPythonista3] = []
    ...
    def service_handle(self) -> int:
        return int(str(self.obj.service().startHandle()))
